...
## Does it require changes to my theme?
Not typically. The capture surface is the Shopify App Pixel, not theme code.

## Will it increase ad performance?
No guarantees are made. Platform behavior varies based on configuration, consent, and policies.
